...
def resample(sqlContext, df, time_in_sec=900, tolerance="1days", key_cols=None):
    """
        ...
        :param tolerance: tolerance when looking into the future for matching rows
    ...
    resampled_df = clk_pulse_keys.futureLeftJoin(df, tolerance=tolerance, key=key_cols)
